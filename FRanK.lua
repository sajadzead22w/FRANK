------------------------------------------------
-- This Source Was Developed By (FRanK) @GGGGCG.--
--   This Is The Source Channel @GGGGCG .   --
--                - 𝙼𝙾𝙷𝙰𝙼𝙼𝙴𝙳-                 --
--        -- https://t.me/GGGGCG --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,1118196559}  
...
if UserId == 1118196559 then
Status = true
elseif UserId == 1118196559 then
Status = true
...
if tonumber(msg.sender.user_id) == 1118196559 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1118196559 then
...
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ▢ ︙ تم الغاء امر تعيين الايدي عام","md",true)  
...
LuaTele.sendText(msg_chat_id,msg_id,'▢ ︙تم تعيين الايدي الجديد',"md",true, false, false, false, reply_markup)
end
...
download('https://raw.githubusercontent.com/FRanK-Main/FRanK/FRanK.lua','FRanK.lua')
...
Redis:set(TheFRanK..'FRanK:Num:Add:Bot',text:match("تعيين عدد الاعضاء (%d+)$") ) 
...
if text == 'تغيير الايدي' or text == 'تغيير الايدي' then
...
{
{text = '❲ 𝙼𝙾𝙷𝙰𝙼𝙼𝙴𝙳 ❳', url = "https://t.me/IlDOIl"}
},
}
...
data = {
{
{text = 'قناة السورس', url = 't.me/IlDOIl'}, 
},
}
}
...
if text == 'مسح رسائلي' or text == 'رم' then
...
local UserId_Info = LuaTele.searchPublicChat("GGGGCG")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/GGGGCG"}
},
{
{text = '❲ 𝙼𝙾𝙷𝙰𝙼𝙼𝙴𝙳 ❳', url = "https://t.me/IlDOIl"},
},
...
data = {
{
{text = 'Channel Source ،', url = 't.me/IlDOIl'}, 
},
{
{text = 'Annotations Source', url = 't.me/IlDOIl'}, 
},
{
{text = 'programmer Source', url = 't.me/GGGGCG'}, 
},
{
{text = 'Developer Source !', url = 't.me/GGGGCG'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
return LuaTele.sendText(msg_chat_id,msg_id,'*خالتڪك جࢪت وࢪاي  😹💕*',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*امـشـيڪ بـيها عمࢪيي😗😹 ️*',"md",true)  
end
...
if text == (Redis:get(TheFRanK.."FRanK:Name:Bot") or "محمد") then
local NamesBot = (Redis:get(TheFRanK.."FRanK:Name:Bot") or "محمد")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات محمد بعدين اجاوبك",
...
Redis:set(TheFRanK.."FRanK:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
...
Redis:set(TheFRanK.."FRanK:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheFRanK.."FRanK:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
...
local CmdStart = '*\n▢ ︙أهلآ بك في بوت '..(Redis:get(TheFRanK.."FRanK:Name:Bot") or "محمد")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/IlDOIl'},{text = '᥀ لتنصيب بوت .', url = 't.me/GGGGCG'}, 
},
{
